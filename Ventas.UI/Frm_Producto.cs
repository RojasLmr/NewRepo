    ...
    public partial class Frm_Producto : Form
    {
        ...
        {
            {
                ...
                txtPrecio1.Text = DataProducto.CurrentRow.Cells[4].Value.ToString();
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            if (btn_Guardar.Text == "Guardar")
            {
                ...
                objPro.precio_venta = Convert.ToDecimal(txtPrecio1.Text);
            ...
            else if (btn_Guardar.Text == "Actualizar")
            {
                ...
                producto.precio_venta = Convert.ToDecimal(txtPrecio1.Text);
                try
                {
        ...
        {
            ListarCategoria();
            DataProducto.DataSource = bll.ListarenOrden();
